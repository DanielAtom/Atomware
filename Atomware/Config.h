...
public:
    ...
    struct Aimbot {
        ...
        float smooth{ 1.0f };
        int bone{ 0 };
        float maxAimInaccuracy{ 100.0f };
        float maxShotInaccuracy{ 100.0f };
        int hitchance{ 0 };
        int minDamage{ 1 };
        bool killshot{ false };
        ...
        bool ragebot{ false };
        int shotdelay{ 0 };
        bool hitboxes[25]{ false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false, false};
    };
    ...
    std::array<Backtrack, 40> backtrack;
    ...
    struct {
        ...
        int skybox{ 0 };
        bool thirdpersonspectate{ false };
        ColorToggle world;
        ColorToggle sky;
    ...
    struct {
        ...
        unsigned int indicators_font{ 0 };
        int banColor{ 6 };
        ...
        int hitSound{ 0 };
        int chokedPackets{ 0 };
        std::string unboxname{ "" };
        std::string unboxskin{ "" };
        ...
        bool doorspam{ false };
        bool doorspamtoggled{ false };
        ColorToggle eventlogcolor;
        unsigned int eventlog_font{ 0 };
